...
(function($) {
	...
	$.fn.lightBox = function(settings) {
			...
			if ( jQueryMatchedObj.length == 1 ) {
				...
				for ( var i = 0; i < jQueryMatchedObj.length; i++ ) {
					settings.imageArray.push(new Array(jQueryMatchedObj[i].getAttribute('href'),
										...
										jQueryMatchedObj[i].getAttribute('photoid'),
										jQueryMatchedObj[i].getAttribute('thumb'),
										jQueryMatchedObj[i].getAttribute('width'),
										jQueryMatchedObj[i].getAttribute('height')));
				}
			}
		...
		function _set_image_to_view() { // show the loading
			...
			document.location.hash = '#'+settings.imageArray[settings.activeImage][2];
		};
		/**
		 * Perfomance an effect in the image container resizing it
		 *
		...
		function _show_image_data() {
			...
			if ( settings.imageArray[settings.activeImage][1] ) {
				...
				caption += '<img class="product-image" src="'+settings.imageArray[settings.activeImage][3]+'" style="display:none;">';
